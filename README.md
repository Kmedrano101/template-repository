...
For internal team guidance on naming conventions, commit messages, pull requests, and workflow management, see the [Best Practices](docs/best-practices.md) document.