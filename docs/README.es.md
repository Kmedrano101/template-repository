...
Para la guía interna del equipo sobre convenciones de nomenclatura, mensajes de commit, pull requests y gestión de flujos de trabajo, consulta el documento de [Buenas Prácticas](best-practices.es.md).
